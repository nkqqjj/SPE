function [ intensity,specular_mask,dark_mask, ret, dep, opi ] = ReadPolarGeneral3_noFFC(path, filename, mode,thres_overexpose,thres_underexpose)
...
% read raw image data    
A=double(imread(full_filename));
[B11,B12,B21,B22] = PolarCamInterpolation(A);

intensity=uint8((B11+B12+B21+B22)/4);
