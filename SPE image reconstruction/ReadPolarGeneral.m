function [ intensity,specular_mask, ret, dep, opi ] = ReadPolarGeneral(path, filename, mode,thres)
...
specular_mask = (B11_raw>thres|B12_raw>thres|B21_raw>thres|B22_raw>thres);%this is not flat field corrected. Used for specular high light detection
