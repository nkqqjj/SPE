function [ BW4 ] = mark_specular_fun_linewidth( BW1,linewidth )
%HH is co-polarised image, Intensity is m00 image
%   BW1 is the mask, img is to be overlayed, linewidth is a number from 3
%   to 20
...
se = strel('square',linewidth);%define line width
BW4 = imdilate(BW3,se);
